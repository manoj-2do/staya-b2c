...
export function BookingSummaryCard({ selectedRoom, className }: BookingSummaryCardProps) {
    if (!selectedRoom) {
        return (
    ...
    return (
        <div className={`border border-gray-200 rounded-xl p-6 shadow-xl shadow-gray-200/50 bg-white ${className}`}>
            <div className="space-y-6">
                ...
                <Button className="w-full h-12 text-lg font-semibold bg-primary hover:bg-primary/90 shadow-md transition-all">
                    Continue
                </Button>
            </div>
        </div>
